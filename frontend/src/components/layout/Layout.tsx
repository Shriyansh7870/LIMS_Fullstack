...
export default function Layout() {
  ...
  return (
    <div className="flex h-screen overflow-hidden" style={{ background: '#F4F6F9' }}>
      ...
      {/* ─── SIDEBAR ─────────────────────────────────────────────── */}
      <aside
        className="flex flex-col flex-shrink-0 z-20 transition-[width] duration-300"
        style={{
          width:    sidebarOpen ? '252px' : '0',
          minWidth: sidebarOpen ? '252px' : '0',
          background: SB_BG,
      ...
      >
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 }}>
            ...
            <div>
              <div style={{ fontFamily: "'Syne', sans-serif", fontWeight: 800, fontSize: 15, lineHeight: 1.15, color: '#fff', whiteSpace: 'nowrap' }}>
                Quantum <span style={{ color: GOLD_L }}>Kairoz</span>
              </div>
              <div style={{ fontSize: 9, color: 'rgba(255,255,255,0.22)', letterSpacing: '1.6px', textTransform: 'uppercase', marginTop: 1 }}>
          ...
          <div style={{
            ...
            border: '1px solid rgba(196,154,44,0.16)',
          }}>
            <div style={{ width: 6, height: 6, borderRadius: '50%', background: '#22C55E', boxShadow: '0 0 5px #22C55E', flexShrink: 0 }} />
            <span style={{ fontSize: 9, fontWeight: 700, color: GOLD, letterSpacing: '1.4px', textTransform: 'uppercase' }}>
              System Live · Quality Intelligence
            </span>
          </div>
        </div>
